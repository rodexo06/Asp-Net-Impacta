...
namespace ExercicioManiImg.DAL
{
        ...
        public int Incluir(Funcionario funcionario)
        {
            using (var db = new NorthwindEntities())
            {
                ...
                funcionario.Foto.Length > 0)
                {
                    ...
                    string.Format("{0}{1}", funcionario.FuncionarioID,funcionario.FotoPath);
                    db.SaveChanges();
                }
            }
        ...
        public void Alterar(Funcionario funcionario)
        {
            ...
            using (var db = new NorthwindEntities())
            {
                ...
                if (original != null)
                {
                    ...
                    {
                        original.FotoPath = string.Format("{0}{1}", funcionario.FuncionarioID, funcionario.FotoPath);
                    }
                    db.SaveChanges();
                }
                else
